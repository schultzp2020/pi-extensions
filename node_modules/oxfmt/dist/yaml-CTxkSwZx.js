...
var Ii = Object.getPrototypeOf, _i = Object.prototype.hasOwnProperty;
var ne = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), or = (t, e) => {
...
var on = (t, e, n) => (n = t != null ? ki(Ii(t)) : {}, xi(e || !t || !t.__esModule ? sn(n, "default", {
	value: t,
	enumerable: !0
}) : n, t));
var ce = ne((B) => {
...
var Bi = () => {}, je = Bi;
var Qe = "string", Ge = "array", dt = "cursor", gt = "indent", Ae = "align", yt = "trim", Le = "group", Te = "fill", Ce = "if-break", Et = "indent-if-break", Me = "line-suffix", St = "line-suffix-boundary", re = "line", wt = "label", ke = "break-parent", bt = new Set([
	dt,
	gt,
	Ae,
	yt,
...
var wr = (t) => Sr.test(t), br = (t) => Er.test(t), Nr = (t) => yr.test(t), Or = (t) => `# @${gr}
...
var tt = (t) => t.position.start.offset, vr = (t) => t.position.end.offset;
function Xi(t) {
