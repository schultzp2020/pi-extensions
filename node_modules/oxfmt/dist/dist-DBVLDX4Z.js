import { a as __toESM, t as __commonJSMin } from "./chunk-DSjvVL_1-DvmJ8i3j.js";
import { n as loadIfExists, r as maybeResolve, t as expiringMap } from "./resolve-pWjAK-4f-BnvQ49el.js";
import { i as visit, n as cacheForDirs, r as spliceChangesIntoString } from "./utils-D8dQkKEd-CoIwOuFZ.js";
import { a as sortClasses, i as sortClassList, n as error, o as warn, r as getTailwindConfig$1 } from "./sorter-BZkvDMjt-CgLjPuXI.js";
...
const { parsers, printers } = createPlugin([
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./html-CC61hPUL.js")
		}],
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./glimmer-0WQITj6v.js")
		}],
		parsers: { glimmer: {} },
	...
	defineTransform({
		...
		parsers: {
			...
			typescript: { load: [{
				...
				importer: () => import("./typescript-Cg8onQ4r.js")
			}] },
			meriyah: { load: [{
				name: "prettier/plugins/meriyah",
				importer: () => import("./meriyah-CIaAh_Jq.js")
			}] },
			acorn: { load: [{
				name: "prettier/plugins/acorn",
				importer: () => import("./acorn-K_XpABqm.js")
			}] },
			flow: { load: [{
				name: "prettier/plugins/flow",
				importer: () => import("./flow-BthqNux8.js")
			}] },
			oxc: { load: [{
